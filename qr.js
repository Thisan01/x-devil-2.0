...
async function whatsAsena() {
  ...
  conn.on('connecting', async () => {
    console.log(`${chalk.green.bold('X-Devil')}${chalk.green.bold('Team')}
${chalk.white.italic('devil String code recipient')}
${chalk.blue.bold('ℹ️  Connecting devil... Please wait.')}`);
  });

  conn.on('open', async () => {
    console.log(
      chalk.green.bold('Devil QR Code: '),
      'DEVIL;;;' +
